...
const promotions = [
    { 'id': 1, 'title': '30% OFF' },
    { 'id': 2, 'title': '$25.00 Discount' },
    { 'id': 3, 'title': 'Free Shipping' },
    { 'id': 4, 'title': '+ $100.00 on limit' }
]

const merchants = [
  { 'id': 1, 'title': 'SHOP Marketplace', 'shipping': 75.00 },
  { 'id': 2, 'title': 'TrueGreen', 'shipping': 35.00 },
  { 'id': 3, 'title': 'Zoro', 'shipping': 99.00 }
]
